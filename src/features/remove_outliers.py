...
plot_binary_outliers(
    col=col, dataset=dataset, outlier_col=col + "_outlier", reset_index=True
)
...
for col in outliers_columns:
    plot_binary_outliers(
        col=col, dataset=dataset, outlier_col="outlier_lof", reset_index=True
    )
...
for col in outliers_columns:
    for label in df["label"].unique():
        ...
        print(f"Removed {n_outliers} from {col} for label {label}")
# --------------------------------------------------------------
